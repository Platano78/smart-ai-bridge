...
# Smart AI Bridge v1.6.0 - Configuration Guide
...
#### v1.6.0 Intelligence Layer Configuration
```bash
# Intelligence Layer (v1.6.0+)
ENABLE_LEARNING=true               # Enable pattern learning and playbooks
PATTERN_DATABASE_PATH=./data/patterns.db
PLAYBOOK_DATABASE_PATH=./data/playbooks.db
MAX_PATTERNS_CACHED=1000           # Maximum patterns to cache in memory
LEARNING_SAMPLE_RATE=0.1           # Fraction of requests to sample for learning

# Subagent Backend Overrides (v1.3.1+)
SUBAGENT_BACKEND_CODE_REVIEWER=deepseek
SUBAGENT_BACKEND_SECURITY_AUDITOR=deepseek
SUBAGENT_BACKEND_PLANNER=qwen3
SUBAGENT_BACKEND_REFACTOR_SPECIALIST=qwen3
SUBAGENT_BACKEND_TEST_GENERATOR=deepseek
SUBAGENT_BACKEND_DOCUMENTATION_WRITER=qwen3
SUBAGENT_BACKEND_TDD_DECOMPOSER=qwen3
SUBAGENT_BACKEND_TDD_TEST_WRITER=deepseek
SUBAGENT_BACKEND_TDD_IMPLEMENTER=qwen3
SUBAGENT_BACKEND_TDD_QUALITY_REVIEWER=deepseek
```
...
This comprehensive configuration guide covers all aspects of setting up and tuning Smart AI Bridge v1.6.0 for optimal performance and security.
